...
##            print "No matches"
    ...
    def get_concordance_as_matrix(self, word, width=75, lines=25):
        """
        Returns a matrix of the concordance.
        Returns None if no matches found
        ...
        if offsets:
            ...
            for i in offsets:
                ...
                ## fix the padding
                if left[0] == ' ':
                    tokens_left[0] = '&nbsp;' + tokens_left[0]
                if right[0] == ' ':
                    tokens_right[0] = '&nbsp;' + tokens_right[0]

                concordance_row = []                
                concordance_row.extend(tokens_left)
                concordance_row.append(self._tokens[i])
                concordance_row.extend(tokens_right)

                concordance_matrix.append(concordance_row)
